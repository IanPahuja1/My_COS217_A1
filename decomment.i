...
enum State {
    ...
    CHARACTER_LITERAL,
    STRING_LITERAL,
    ESCAPED_CHARACTER_IN_CHAR_LITERAL,
    ESCAPED_CHARACTER_IN_STRING_LITERAL
};

int main(void) {
    enum State state = OUTSIDE_COMMENT;
    int line_number = 1;
...
# 22 "decomment.c"
        ...
        case ESCAPED_CHARACTER_IN_CHAR_LITERAL:
            putchar(ch);
            state = CHARACTER_LITERAL;
            break;

        case ESCAPED_CHARACTER_IN_STRING_LITERAL:
            putchar(ch);
            state = STRING_LITERAL;
            break;
        }
